...
public class KontrolaHWPBVController implements Initializable{
    ...
    void OnClickRefresh(ActionEvent event) throws SQLException, IOException {
        ...
        Parent quailParent = FXMLLoader.load(getClass().getResource("TableQuail.fxml"));
    ...
    void OnClickUloz(ActionEvent event) throws SQLException {
        System.out.println("vytvorenie PBV");
        ...
        JDBMySQLConnection.addtoPbv(getVyberskladu(ChoiceBoxSklad),TFTyp.getText(),TFNazov.getText(),TFPocet.getText(), TFSeriove.getText(), datumodoslania,zaruka, TAPoznamka.getText());
